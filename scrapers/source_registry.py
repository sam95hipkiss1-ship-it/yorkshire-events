...
GENERIC_SOURCES = (
    ...
    SourceConfig("Welcome to Sheffield", "welcometosheffield.co.uk", ("https://www.welcometosheffield.co.uk/visit/whats-on/all-events/",), notes="Handled by source-specific listing adapter"),
    ...
    SourceConfig("Visit East Yorkshire", "visiteastyorkshire.co.uk", ("https://www.visiteastyorkshire.co.uk/whats-on/event-calendar/",), notes="Calendar is loaded dynamically; dedicated adapter required"),
    SourceConfig("Visit Hull", "visithull.com", ("https://www.visithull.com/whatson/",), notes="Calendar is loaded dynamically; dedicated adapter required"),
    ...
    SourceConfig("Yorkshire Wildlife Park", "yorkshirewildlifepark.com", ("https://www.yorkshirewildlifepark.com/events/",), notes="Dedicated adapter required"),
    ...
    SourceConfig("York Museums Trust", "yorkmuseumstrust.org.uk", ("https://www.yorkmuseumstrust.org.uk/whats-on/",), notes="Dedicated adapter required"),
